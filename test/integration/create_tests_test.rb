...
class CreateTestsTest < ActionDispatch::IntegrationTest
  ...
  test 'create SOW' do
    ...
    assert_nil StatementOfWork.find_by(number: "222", purchase_order_number: "345", client: "Harold")
    ...
    assert_not_nil StatementOfWork.find_by(number: "222", purchase_order_number: "345", client: "Harold")
